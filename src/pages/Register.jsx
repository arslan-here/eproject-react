...
<div className='pb-6 text-left'>
 ...
 <p className='font-thin text-sm text-black'>Start your website in seconds. Already have an account? <Link to={'/login'}><span class="text-blue-700 font-semibold">Sign In</span></Link> .</p>
</div>
<div class="mb-5 text-left">
    <label  class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your Name</label>
    <Field name="name" type="text"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name" required />
